...
In the root folder you will find two jupiter notebooks [^1], which cover all the concepts, structs and syntax of Python. If you have a limited time, looking for a fast-track way of learning Python, you can just use these notebooks to understand and play aroung with them, instead of taking days of courses, watching hours of videos. 
...
## Prerequisites
* Pyhton: You need to install [Python](https://www.python.org/downloads/) to your operating system. This project is tested in Python 3.12.1.
...
* You will need an editor to run Jupiter notebooks.
    * You can install [VS Code](https://code.visualstudio.com/Download).
    * Once VS Code is intalled, you will also need to install [Python extension](https://marketplace.visualstudio.com/items?itemName=ms-python.python)
